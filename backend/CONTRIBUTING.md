Contributing to ArthaNetra Backend

Thanks for your interest in improving ArthaNetra! This document explains local setup, coding standards, and how to propose changes for the backend API.
