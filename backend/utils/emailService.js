...
const sendVerificationEmail = async (email, verificationToken, unsubscribeToken) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: 'Please verify your email subscription - ArthaNetra',
    html: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
      ...
      <body>
          ...
          <div class="content">
              ...
              <p>Thank you for subscribing to ArthaNetra updates. We're excited to keep you informed about:</p>
              
              <ul>
                  <li>🏛️ New features in the ArthaNetra MPLADS Platform</li>
              ...
              <p>Questions or concerns? Email us at <a href="mailto:ayushssingh208@gmail.com">ayushssingh208@gmail.com</a>.</p>
          </div>
          
          <div class="footer">
              <p>© 2025 ArthaNetra • Making government data accessible</p>
              <p>This email was sent because you requested to subscribe to our updates at <span style="color: inherit;">arthanetra.in</span></p>
...
const sendWelcomeEmail = async email => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: 'Welcome to ArthaNetra Community! 🇮🇳',
    html: `
      <!DOCTYPE html>
      <html lang="en">
      <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Welcome to ArthaNetra</title>
          <style>
              body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
              .header { background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: white; padding: 30px; text-align: center; border-radius: 8px 8px 0 0; }
              .content { background: #f9f9f9; padding: 30px; border: 1px solid #ddd; }
      ...
      <body>
          ...
          <div class="content">
              ...
              <div class="feature">
                  <h3>🏛️ ArthaNetra MPLADS Platform</h3>
          ...
          <div class="footer">
              <p>© 2025 ArthaNetra • Making government data accessible</p>
              <p>You received this because you verified your subscription at <span style="color: inherit;">arthanetra.in</span></p>
              <p><a href="${unsubscribeUrl}" style="color: #93c5fd; text-decoration: underline;">Unsubscribe</a></p>
          </div>
      </body>
      </html>
