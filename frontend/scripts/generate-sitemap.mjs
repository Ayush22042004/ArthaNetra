...
try {
  ...
  // Sitemap generation can still run with defaults when no local .env exists.
}

const DEFAULT_SITE_URL = 'https://arthanetra.in'
const DEFAULT_API_BASE_URL = 'https://api.arthanetra.in/api'
