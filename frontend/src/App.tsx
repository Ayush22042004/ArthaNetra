        ...
        <Router>
          <div className="app">
            ...
            <Routes>
              ...
              <Route path="/map" element={withRouteFallback(<IntelligenceMap />)} />
              <Route path="/maps" element={withRouteFallback(<IntelligenceMap />)} />
              <Route path="/architecture" element={withRouteFallback(<SystemArchitecture />)} />
              <Route path="/ai-core" element={withRouteFallback(<SystemArchitecture />)} />
              <Route path="/flow-chart" element={withRouteFallback(<SystemArchitecture />)} />
              ...
              >
                ...
                <Route
                  path="risk-analysis"
                  element={withRouteFallback(<RiskAnalysis />, 'route-fallback--mplads')}
                />
                <Route
                  path="map"
                ...
                <Route
                  path="architecture"
                  element={withRouteFallback(<SystemArchitecture />, 'route-fallback--mplads')}
                />
                <Route
                  path="ai-core"
                  element={withRouteFallback(<SystemArchitecture />, 'route-fallback--mplads')}
