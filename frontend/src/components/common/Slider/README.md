...
A beautiful, polished range slider component designed specifically for the ArthaNetra MPLADS Platform. Features smooth animations, accessibility support, and professional government dashboard aesthetics.
