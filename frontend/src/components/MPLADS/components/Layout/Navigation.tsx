...
const Navigation = () => {
  ...
  const navItems = [
    ...
    {
      title: 'AI Risk',
      path: '/mplads/risk-analysis',
      icon: <FiAlertTriangle />,
      description: 'AI project risk analysis',
      category: 'secondary',
    },
    {
      title: 'Feedback',
  ...
  const hiddenRouteLabels = {
    '/mplads/map': 'Intelligence Map',
    '/mplads/maps': 'Intelligence Map',
              ...
              <>
                ...
                <li className="breadcrumb-item breadcrumb-current" aria-current="page">
                  {(() => {
                    ...
                    return currentItem?.title || hiddenRouteLabels[location.pathname] || 'Page'
                  })()}
                </li>
              </>
            )}
