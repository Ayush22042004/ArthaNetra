    ...
    <div className="dashboard">
      <div className="dashboard-header">
        <div className="dashboard-title-section">
          <span className="intel-kicker">Civic infrastructure command center</span>
          <h1>ArthaNetra Intelligence & Project Monitoring</h1>
          <p>
            Monitor public works, fund movement, completion gaps and risk signals across India.
          </p>
        </div>
        ...
        <>
          ...
          <div className="charts-section" ref={chartsSectionRef}>
            <CollapsibleSection
              ...
              subtitle="Operational signals for allocation, utilization and constituency performance"
              icon={<FiBarChart2 />}
              defaultOpen={true}
            ...
            <CollapsibleSection
              ...
              subtitle="Track work execution, pending liabilities and completion momentum"
              icon={<FiActivity />}
              defaultOpen={true}
              className="dashboard-section"
            >
            ...
            <Card className="info-card">
              ...
              <CardContent>
                <p>
                  ...
                  This intelligence platform turns public scheme records into searchable monitoring,
                  risk and geospatial signals for faster civic oversight.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="info-card">
              ...
              <CardContent>
                <div className="quick-actions">
                  ...
                  <Button
                    className="action-btn bg-blue-600 text-white hover:bg-blue-700"
                    onClick={() => navigate('/mplads/risk-analysis')}
                    variant="default"
                  >
                    Review AI Risk
                  </Button>
