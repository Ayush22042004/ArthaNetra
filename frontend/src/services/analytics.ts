...
/**
 * Safe Analytics Service for ArthaNetra MPLADS Platform
...
class AnalyticsService {
  ...
  init() {
    try {
      ...
      const analyticsFlag = import.meta.env?.VITE_ENABLE_ANALYTICS === 'true'

      if (!analyticsFlag || !trackingId || trackingId.startsWith('your_')) {
        this.isEnabled = false
